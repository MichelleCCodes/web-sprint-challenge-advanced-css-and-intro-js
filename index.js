...
function addArtist(array){
    let text = {id: 20, name: "Your Name Here", years: "Your Birth Year - current day", genre: "Web Design", nationality:"Your Nationality Here", bio: "Add 1-2 sentences (or use lorem ipsum)"}
    array.push({text})
    return array
  }
